...
| --- | --- | --- | --- | --- |
| **Accounts** — cuentas y login | `accounts` | [`accounts-integration`](plugins/accounts/skills/accounts-integration/SKILL.md) | Signup, signin, refresh token, OAuth, magic link, código de acceso por correo, webhooks, roles y behaviors, integrados en tu código | 0.2.1 |
